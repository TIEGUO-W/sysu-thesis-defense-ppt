...
\begin{frame}{Key Optimization: Column Normalization}
    \begin{figure}
        \includegraphics[width=0.65\textwidth]{fig/thesis/fig_04_p19.jpg}
        \caption{Column normalization improves ElasticNet fitting: cond=100, 5 independent runs all achieve MSE=$10^{-4}$ to $10^{-9}$}
    \end{figure}
\end{frame}

\begin{frame}{Non-negative SVD + Non-negative ElasticNet}
    \begin{figure}
        \includegraphics[width=0.65\textwidth]{fig/thesis/fig_06_p22.jpg}
        \caption{Combined non-negative SVD matrix + non-negative ElasticNet optimization: Exp1/Exp3 reach MSE=$10^{-9}$}
    \end{figure}
\end{frame}
...
\begin{frame}{Intercept Fitting Analysis}
    \begin{columns}
        ...
        \begin{figure}
            ...
            \caption{Good case: small intercept, accurate reconstruction}
        \end{figure}
        \column{0.48\textwidth}
        \begin{figure}
            \includegraphics[width=\textwidth]{fig/thesis/fig_08_p23.jpg}
            \caption{Bad case: large intercept, degraded reconstruction}
        \end{figure}
    \end{columns}
\end{frame}
...
\begin{frame}{Source-Detector Geometry}
    \begin{columns}
        ...
        \begin{figure}
            \includegraphics[width=\textwidth]{fig/thesis/fig_12_p27.jpg}
            \caption{Grid division: 10 sources mapped to 12 cells, 8 detectors}
        \end{figure}
        \column{0.5\textwidth}
...
\begin{frame}{Reconstruction Visualization}
    \begin{columns}
        ...
        \begin{figure}
            ...
            \caption{True vs. estimated source distribution}
        \end{figure}
        \column{0.5\textwidth}
        \begin{figure}
            \includegraphics[width=\textwidth]{fig/thesis/fig_13_p30.jpg}
            \caption{Contribution matrix heatmap (8$\times$12)}
        \end{figure}
    \end{columns}
\end{frame}
...
\begin{frame}{Condition Number Impact}
    \begin{figure}
        \includegraphics[width=0.7\textwidth]{fig/thesis/fig_16_p36.jpg}
        \caption{Comparison of adaptive CV, segmented search, multi-segment grid, and fusion strategies}
    \end{figure}
\end{frame}
...
\begin{frame}{Bayesian Optimization Results}
    \begin{columns}
        ...
        \begin{figure}
            ...
            \caption{Bayesian optimization: sparse source reconstruction}
        \end{figure}
        \column{0.48\textwidth}
        \begin{figure}
            \includegraphics[width=\textwidth]{fig/thesis/fig_21_p40.jpg}
            \caption{Bayesian + PHITS Monte Carlo validation}
        \end{figure}
    \end{columns}
\end{frame}
